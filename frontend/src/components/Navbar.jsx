...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between text-sm py-2 mb-2 border-b border-b-[#ADADAD]">
      <img
        onClick={() => navigate("/")}
      ...
      <div className="flex items-center gap-4 ">
        {token && userData && <NotificationBell />}
        {token && userData ? (
        ...
        >
          <div className="flex items-center justify-between px-5 py-6">
            <img src={assets.family} className="w-36" alt="" />
            <img
