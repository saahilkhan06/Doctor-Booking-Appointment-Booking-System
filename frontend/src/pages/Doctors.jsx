  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div
          className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? "flex" : "hidden sm:flex"} bg-white p-3 rounded-lg`}
        >
          <p
            onClick={() =>
        ...
        <div className="w-full grid grid-cols-auto gap-10">
          {filterDoc.map((item, index) => (
            <div
              ...
              className="border rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500 border-teal-500 bg-white"
              key={index}
            >
